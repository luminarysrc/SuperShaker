  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* G-code Upload */}
        <label
          className="w-10 h-10 rounded-lg transition-all flex items-center justify-center cursor-pointer active:scale-95 hover:bg-white/5 focus-within:ring-2 focus-within:ring-lime-500 focus-within:outline-none"
          style={toolbarBtnStyle}
