  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* G-code Upload */}
        <label
          className="w-10 h-10 rounded-lg cursor-pointer transition-all flex items-center justify-center active:scale-95 focus-visible:ring-2 focus-visible:ring-lime-500 focus-visible:outline-none focus-within:ring-2 focus-within:ring-lime-500 focus-within:outline-none"
          style={toolbarBtnStyle}
