...
function LayerRow({ def, checked, onChange }) {
  return (
    <label
      className="focus-within:ring-2 focus-within:ring-lime-500 focus-within:outline-none flex items-center gap-2.5 px-2 py-1.5 rounded-md cursor-pointer transition-colors"
            ...
            <div className="space-y-4 text-sm" style={{ color: "var(--ss-text)" }}>
              ...
              <div className="pt-2">
                {pendingFile ? (
                  ...
                  <div className="flex items-center gap-2">
                    <label className="focus-within:ring-2 focus-within:ring-lime-500 focus-within:outline-none ss-btn-ghost flex-1 py-2 text-center cursor-pointer text-xs">
                      Choose .csv or .xlsx
