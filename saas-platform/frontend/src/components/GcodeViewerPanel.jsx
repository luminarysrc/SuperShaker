  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* G-code Upload */}
        <label
          className="w-10 h-10 rounded-lg cursor-pointer transition-all flex items-center justify-center active:scale-95 focus-within:ring-2 focus-within:ring-lime-500 focus-within:outline-none focus-within:bg-black/10 dark:focus-within:bg-white/10"
          style={toolbarBtnStyle}
            ...
            <div className="space-y-4 text-sm" style={{ color: "var(--ss-text)" }}>
              ...
              <div className="pt-2">
                {pendingFile ? (
                  ...
                  <div className="flex items-center gap-2">
                    <label className="ss-btn-ghost flex-1 py-2 text-center cursor-pointer text-xs focus-within:ring-2 focus-within:ring-lime-500 focus-within:outline-none rounded-lg">
                      Choose .csv or .xlsx
