      ...
      >
        <div className="p-4 space-y-5">
          ...
          <section className="space-y-2">
            ...
            <label className="ss-btn-ghost w-full text-sm text-center block cursor-pointer py-2.5 focus-within:ring-2 focus-within:ring-lime-500 focus-within:outline-none rounded-lg">
